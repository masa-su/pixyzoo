...
def full_dataloader(seq_size, init_size, batch_size, test_size=16, data_path="3dmaze_32.npy"):
    train_loader = HRSSMDataset(length=seq_size + init_size * 2, partition='train', path=data_path)
    test_loader = HRSSMDataset(length=seq_size + init_size * 2, partition='test', path=data_path)
